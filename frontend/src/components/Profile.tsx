...
import AvatarViewer from "./Profile3D"; // 3D model component
import Devices from "./Devices"; // If Devices uses R3F hooks, ensure it’s wrapped in a Canvas inside its own component
  ...
  return (
      <div className="profile">
        ...
        <div className="profile__info">
          ...
          <p>
            <strong>Social Insurance Number:</strong> {userProfile.socialInsuranceNumber}
          </p>
          <p>
        ...
        <div className="profile__avatar">
          <div className="profile__avatar__label profile__avatar__label-title">
            Body Measurements
          </div>
            ...
            <div className="profile__avatar-info-left">
              <div className="profile__avatar-info-para">
                <div className="profile__avatar-info-para__container">
                  ...
                  <span className="profile__avatar-info-value">{userProfile.height} cm</span>
                </div>
              ...
              <div className="profile__avatar-info-para">
                <div className="profile__avatar-info-para__container">
                  ...
                  <span className="profile__avatar-info-value">{userProfile.weight} kg</span>
                </div>
                <div className="ruler-lines">
                  <span className="small"></span>
                  <span className="small"></span>
        ...
        {/* If Devices uses any Three.js hooks, ensure it is wrapped in its own Canvas or does not use them */}
